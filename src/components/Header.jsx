    ...
    <div className='header'>
      <div className="container">
          <div className="top row">
              <div className="col">
                  <div className="topDiv">
                        ...
                        <span>+91 6803345678</span>
                  </div>
                  <div className="topDiv">
                        <FontAwesomeIcon icon={faEnvelope} />
                        <span>MyCartSupport@gmail.com</span>
                  </div>
              </div>
              <div className="col">
                <div className="topDiv">
          ...
          <div className="middle row">
              <div className="col" width="40px" height ="30px">
                    <Link to="/"><img src="./assets/images/cartlogo.jpg" alt="Logo" style={{height : 100, width :140} } / ></Link>                  
              </div>
              <div className="col">
                <div className="nav">
                    <ul>
